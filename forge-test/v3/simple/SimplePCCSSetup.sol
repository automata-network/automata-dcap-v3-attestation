...
import {EnclaveIdentityJsonObj, EnclaveIdentityHelper} from "@automata-network/on-chain-pccs/helper/EnclaveIdentityHelper.sol";
...
abstract contract SimplePCCSSetup is Test {
    ...
    function setUp() public virtual {
        ...
        allDao = new AccessControlledPCCS(
